<script>
    ...
    export let links = {
        en: [["Home", "/"], ["Dashboard", "/dashboard"], ["Links", "/links/"], ["About", "/about"]],
        nl: [["Startpagina", "/"], ["Dashboard", "/dashboard"], ["Links", "/links/"], ["Over", "/about"]],
        bg: [["Начало", "/"], ["Табло", "/dashboard"], ["Линкове", "/links/"], ["Относно", "/about"]]
    };
